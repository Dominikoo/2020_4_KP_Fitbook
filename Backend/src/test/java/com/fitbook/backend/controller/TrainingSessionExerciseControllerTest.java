...
@SpringBootTest
public class TrainingSessionExerciseControllerTest {

    @Autowired
    private TrainingSessionExerciseController trainingSessionExerciseController;
    @Autowired
    ...
    public void getTrainingSessionExercisesTest() {
        assertEquals(trainingSessionExercise, trainingSessionExerciseController.getTrainingSessionExercises(trainingSession.getId()).get(0));
    }
